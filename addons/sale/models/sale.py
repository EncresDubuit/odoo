            ...
            if changed_lines:
                ...
                for order in orders:
                    ...
                    if any([values['product_uom_qty'] < x.product_uom_qty for x in order_lines]):
                        ...
                        raise UserError(
                            u"La quantité commandée a été diminuée pour un ou plusieurs articles. Diminuer la quantité commandée sur une commande confirmée n'est pas autorisé ; seule l'augmentation de la quantité est possible. Si rien n'a été livré, vous avez intérêt à annuler la commande, la remettre en brouillon et la reconfirmer. Si une livraison partielle a déjà eu lieu, vous avez intérêt à prévenir le magasin de ne pas tout livrer et de ne pas faire de reliquat lors de la dernière livraison.")
                    msg += "<ul>"
